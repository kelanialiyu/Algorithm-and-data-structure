...
public class Pizzariav2{
    ...
    public static void main(String[] args){
        ...
        Pizzariav2 pizzahut= new Pizzariav2(totalPizza,teamOfTwos,teamOfThrees,teamOfFours,pizzas);
        pizzahut.optimize();
    }
    ...
    Pizzariav2(int totalPizza,int teamOfTwos, int teamOfThrees, int teamOfFours ,Pizza[] pizzas){
