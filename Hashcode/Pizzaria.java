...
public class Pizzaria{
    ...
    public static void main(String[] args){
        ...
        Pizzaria pizzahut= new Pizzaria(totalPizza,teamOfTwos,teamOfThrees,teamOfFours,pizzas);
        pizzahut.optimize();
    }
    ...
    Pizzaria(int totalPizza,int teamOfTwos, int teamOfThrees, int teamOfFours ,Pizza[] pizzas){
